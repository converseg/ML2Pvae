...
First set a few hyper-parameters to build the neural network. Note that \textbf{num_items} and \textbf{num_skills} are fixed by the data set. The core function here is \textbf{build_vae_independent()}, which constructs a modified neural network which can be used for parameter estimation.
