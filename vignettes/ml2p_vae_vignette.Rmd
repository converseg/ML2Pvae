...
```
```{r}
# Construct ML2P-VAE model assuming correlated traits
...
```
```{r}
# Get parameter estimates for independent assumption
...
```{r}
# Evaluate ML2P-VAE model estimates (independent latent trait assumption)
par(pty="s")
...
plot(diff_true, diff_est_ind, pch = '*',
     ...
     xlab = 'True', ylab = 'Estimated')
par(pty="s")
matplot(theta_true[1:200,], all_theta_est_ind[1:200,], pch = '*',
...
```{r}
# Evaluate ML2P-VAE model estimates (correlated latent trait assumption)
par(pty="s")
...
plot(diff_true, diff_est_cor, pch = '*',
     ...
     xlab = 'True', ylab = 'Estimated')
par(pty="s")
matplot(theta_true[1:200,], all_theta_est_cor[1:200,], pch = '*',
        xlim = c(-3,3), ylim = c(-3,3),
        main = 'Ability Parameters',
        xlab = 'True', ylab = 'Estimated')
```
